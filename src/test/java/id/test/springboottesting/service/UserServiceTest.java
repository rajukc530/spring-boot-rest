...
class UserServiceTest {
    ...
    @Test
    void shouldReturnFindAllFilteredusers() {
        List<Object[]> datas = new ArrayList();
        
        Object obj [] = {"raju","admin"};
        
        datas.add(obj);
        
        List<UserRoleDto> actual = new ArrayList<>();
        ...
        when(query.getResultList()).thenReturn(datas);

        List<UserRoleDto> expected = userService.findFilteredusers();
