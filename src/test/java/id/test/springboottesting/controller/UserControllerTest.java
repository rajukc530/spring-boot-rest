...
class UserControllerTest {
    ...
    void setUp() {
        ...
        this.userDtoList = new UserDto(1L, "user1@gmail.com", "pwd1","User1");
    ...
    void shouldFetchAllUsers() throws Exception {
        ...
        Mockito.when(mockModelMapper.map(org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any()))
    ...
    void shouldUpload() throws Exception {
        ...
        mockMvc.perform(
                multipart("/api/users/upload/{id}",appId)
                 .file(file)
